...
void NGLScene::initializeGL()
{
  ...
  ngl::ShaderLib::setUniform("diffuseColour", 0.33f, 0.328f, 0.900f, 1.0f);
  ngl::ShaderLib::setUniform("light.diffuse", 0.33f, 0.328f, 0.918f, 1.0f);
  ngl::ShaderLib::setUniform("light.position", 0.0f, 2.0f, 0.0f);

  ngl::ShaderLib::setUniform("wrap", 0.2f);
  ngl::ShaderLib::setUniform("scatterWidth", 0.2f);
  ngl::ShaderLib::setUniform("scatterColour", 1.0f, 0.0f, 1.0f, 1.0f);
